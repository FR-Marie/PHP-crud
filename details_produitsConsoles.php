...
//--------------------------RECUPERATION DE LA TABLE DE LA BD / REQUETE SQL---------------------------
            if($dbh){
                $sql = "SELECT * FROM produits_consoles WHERE id_produit = ?";
...
<div class="containerConsolesDetails container-fluid mt-5">
    <div class="row text-center w-50 bg-light m-auto p-5">

            <h2 class="h2DetailsProduits"> <?= $details["nom_produit"] ?> </h2>
